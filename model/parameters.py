...
hd_net_args.device = 'cpu'#cuda' if torch.cuda.is_available() else 'cpu' # tensor compute device
...
hd_net_args.act_steering_dim = 10 # number of discrete steering actions
hd_net_args.act_throttle_dim = 10 # number of discrete throttle actions 
hd_net_args.act_brake_dim = 10 # number of discrete brake actions 